...
export function getMessagesForDate(date: Date): string {
  ...
  const messages: Record<string, string> = {
    ...
    '11-29': '❄️ Halooo sayaang, pasti maku suda bosen kan baca inii. Ketik sayang giku kalo bosen, ketik ga sayang giku kalo ga bosen HAHAHAH. Kalo bosen taknak lagi laa, maku taknak baca huuuuu. Maku suda mulai senang disanaaa? Ta sedi sedi lagi kaann, baru 2 hari rasanya lama kali. Suda lupa muka, suara, semua semua maku gimanaa, maku harus menyelamatkan ingatan giku:(',
    '11-30': '🌟 Maku gabut lagi ta hari inii. Cebentar lagi tahun baruuu yeyeyeyy. Humm, memori disini rasanya beda banget sama pas disana, giku terakhir disini masih sama sebelah. Maku harus ingetin giku terus kalo giku sama maku sekarang huhuuu. Sayang maku brut brut brut brut brut brut <3',
    '11-31': '🎊 Huaa besok suda mau taun baru ajaaaaaa. Walau ga bareng, setidaknya sekarang kita masi sama-sama menuju 2026. YEYEYEYEYYY, semangat maku di tahun baru iniiii, perjuangan kita masi panjaaanggg. Sowry gabisa panjang-panjang, lowbat jir gataunyaaa. Papaii, God bless youuu<3',
