...
export function getMessagesForDate(date: Date): string {
  ...
  const messages: Record<string, string> = {
    ...
    '11-27': '⭐ Heyooww sayaaangg, cie suda mau berangkat. Safe flight ya sayaaangg, giku sayang brut brut sama makuuu. Sorry kalo semalem buat maku sedii dihari terakhir maku sebelum ke Jambi. Selamat liburan sayangg, giku jugaa. Janji yaa harus happiii, kalo ada yang buat sedii tetap ceritain ya ke giku mau call atau chat giku bisaaa. Kita coba challenge baru nii, komunikasi pas ga ketemu samsek, ez la yaa. Semangat sayaang, enjoyy yaa. Sayang maku brut brut brut brut brut brut brut brut<3',
